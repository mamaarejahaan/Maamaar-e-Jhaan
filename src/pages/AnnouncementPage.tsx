...
const AnnouncementPage = () => {
  ...
  return (
    <div className=" bg-gray-200 min-h-screen py-20 pb-16 md:py-20 px-4 md:px-10">
        <Navbar />
    <button
            onClick={() => navigate(-1)}
  ...
  {announcements.map((item: any) => (
    ...
    >
      ...
      <CardContent className="flex-1 flex flex-col justify-between px-4 py-5 space-y-4">
        <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-dark to-indigo-700 text-transparent bg-clip-text">
          Announcement
        </h3>

        <ScrollArea className="h-48 pr-2 text-gray-700 whitespace-pre-wrap text-sm leading-relaxed">
          {item.description}
